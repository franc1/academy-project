...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception 
	{
		http
            ...
            .antMatchers("/api/last5articles").hasRole("ADMIN")
            .antMatchers("/api/top-article").hasRole("ADMIN")
            .antMatchers("/api/top5comments").hasRole("ADMIN")
            .antMatchers("/api/worst5comments").hasRole("ADMIN")
